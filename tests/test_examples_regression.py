...
# AGENT SHALL VALIDATE PROCESS test_example_is_valid_json.
...
# AGENT SHALL VALIDATE PROCESS test_example_passes_validation.
...
# AGENT SHALL VALIDATE PROCESS test_example_has_required_fields.
...
# AGENT SHALL VALIDATE PROCESS test_example_has_dimensions.
...
# AGENT SHALL VALIDATE PROCESS test_example_nodes_have_required_fields.
...
# AGENT SHALL VALIDATE PROCESS test_example_edges_have_required_fields.
...
# AGENT SHALL VALIDATE PROCESS test_example_node_ids_unique.
...
# AGENT SHALL VALIDATE PROCESS test_example_edge_refs_valid.
...
# AGENT SHALL VALIDATE PROCESS test_branch_directory_exists.
...
# AGENT SHALL VALIDATE PROCESS test_branch_has_readme.
@pytest.mark.parametrize("branch", ALL_BRANCHES)
...
# AGENT SHALL VALIDATE PROCESS test_core_branch_has_minimum_examples.
...
# AGENT SHALL VALIDATE PROCESS test_advanced_branch_has_minimum_examples.
...
# AGENT SHALL VALIDATE PROCESS test_total_example_count.
