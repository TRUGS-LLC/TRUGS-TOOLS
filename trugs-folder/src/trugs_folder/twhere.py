...
<trl>
PROCESS twhere SHALL SCAN FILE folder_trug_json ACROSS DATA root_tree THEN RETURN RECORD match_list.
</trl>
"""
...
def twhere(
    ...
    <trl>
    FUNCTION twhere SHALL SCAN RECORD node ACROSS ALL FILE folder_trug_json SUBJECT_TO DATA query THEN RETURN RECORD match_list.
    </trl>
    """
