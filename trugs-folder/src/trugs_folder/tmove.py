...
<trl>
PROCESS tmove SHALL MOVE FILE node AND SHALL UPDATE RECORD graph THEN RESTORE FILE node SUBJECT_TO failure.
</trl>
"""
...
def tmove(
    ...
    <trl>
    FUNCTION tmove SHALL MOVE FILE node AND SHALL UPDATE RECORD graph THEN RETURN RECORD trug SUBJECT_TO atomic_rollback ON failure.
    </trl>
    """
