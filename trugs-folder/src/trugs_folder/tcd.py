...
<trl>
PROCESS tcd SHALL RESOLVE RECORD node WITHIN DATA graph SUBJECT_TO DATA target.
</trl>
"""
...
# AGENT claude SHALL DEFINE FUNCTION tcd.
def tcd(
    ...
    <trl>
    FUNCTION tcd SHALL LOAD DATA graph THEN RESOLVE RECORD node BY DATA target AND RETURN RECORD node WITH DATA children AND DATA edges.
    </trl>
    """
