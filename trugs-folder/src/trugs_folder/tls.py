...
<trl>
PROCESS tls SHALL LOAD RECORD graph FROM FILE folder_trug_json THEN RETURN DATA listing.
</trl>
"""
...
def tls(
    ...
    <trl>
    FUNCTION tls SHALL LOAD RECORD graph FROM FILE folder_trug_json THEN RETURN DATA listing SUBJECT_TO format IN text OR json.
    </trl>
    """
