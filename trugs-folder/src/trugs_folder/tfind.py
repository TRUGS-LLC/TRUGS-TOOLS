...
<trl>
PROCESS tfind SHALL FILTER RECORD node FROM DATA graph SUBJECT_TO RECORD predicate THEN RETURN DATA result.
</trl>
"""
...
def tfind(
    ...
    <trl>
    FUNCTION tfind SHALL LOAD DATA graph FROM FILE folder_trug_json THEN FILTER RECORD node SUBJECT_TO RECORD predicate AND RETURN DATA result.
    </trl>
    """
