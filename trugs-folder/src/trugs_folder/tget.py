...
<trl>
PROCESS tget SHALL LOAD FILE folder_trug_json THEN READ RECORD node AND RETURN DATA content.
</trl>
"""
...
def tget(
    ...
    <trl>
    FUNCTION tget SHALL READ RECORD node FROM FILE folder_trug_json THEN RETURN DATA content SUBJECT_TO node_id EXISTS IN graph.
    </trl>
    """
