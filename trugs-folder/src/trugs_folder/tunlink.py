...
<trl>
PROCESS tunlink SHALL FILTER RECORD edge FROM DATA graph THEN WRITE DATA graph TO FILE.
</trl>
"""
...
def tunlink(
    ...
    <trl>
    FUNCTION tunlink SHALL FILTER RECORD edge FROM DATA graph SUBJECT_TO from_id AND to_id AND relation THEN WRITE DATA graph TO FILE SUBJECT_TO dry_run IS FALSE.
    </trl>
    """
