...
<trl>
PROCESS tdelete SHALL DELETE RECORD node AND DELETE RECORD edge FROM DATA graph THEN SAVE DATA graph SUBJECT_TO dry_run EQUALS false.
</trl>
"""
...
def tdelete(
    ...
    <trl>
    FUNCTION tdelete SHALL VALIDATE RECORD node THEN DELETE RECORD node AND DELETE RECORD edge FROM DATA graph THEN RETURN RECORD result.
    </trl>
    """
