...
<trl>
PROCESS tupdate SHALL LOAD RECORD trug_graph THEN WRITE DATA node_properties SUBJECT_TO dry_run FLAG.
</trl>
"""
...
def tupdate(
    ...
    <trl>
    FUNCTION tupdate SHALL LOAD RECORD trug_graph THEN WRITE DATA node_changes TO FILE folder_trug SUBJECT_TO dry_run FLAG.
    </trl>
    """
