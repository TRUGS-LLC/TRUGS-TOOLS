...
class TestTadd:
    ...
    def test_add_infers_type(self, tmp_path):
        ...
        assert added["type"] == "COMPONENT"
        assert added["metric_level"] == "DEKA_COMPONENT"
...
class TestTls:
    ...
    def test_list_shows_type(self, tmp_path):
        ...
        assert types["main.py"] == "COMPONENT"
    ...
    def test_list_with_edges(self, tmp_path):
        ...
        source_id = [n["id"] for n in trug["nodes"] if n.get("type") == "COMPONENT"][0]
