...
def reference_trug_path():
    ...
    p = Path(__file__).parent.parent.parent.parent / "REFERENCE" / "folder.trug.json"
    if p.exists():
        return p
...
def protocol_trug_path():
    ...
    p = Path(__file__).parent.parent.parent.parent / "TRUGS_PROTOCOL" / "folder.trug.json"
    if p.exists():
        return p
...
class TestRendererEdgeCases:
    ...
    def test_load_trug_type_error(self):
        ...
        from trugs_folder.renderer import _load_trug
    ...
    def test_get_edges_from_no_matches(self):
        ...
        from trugs_folder.renderer import _get_edges_from
        trug = {
            "edges": [
    ...
    def test_get_edges_to_no_matches(self):
        ...
        from trugs_folder.renderer import _get_edges_to
        trug = {
            "edges": [
                {"from_id": "a", "to_id": "b", "relation": "calls"}
            ]
